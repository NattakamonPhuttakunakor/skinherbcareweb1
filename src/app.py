...
# ========================================
# 🔧 ส่วนที่ 1: ตั้งค่า Synonym (เพิ่มคำศัพท์ให้ฉลาดขึ้น)
# ========================================
SYNONYM_MAP = {
    'ปวด': ['เจ็บ', 'แสบ', 'บวม', 'อักเสบ', 'จุกแน่น', 'ทรมาน', 'ร้อน'],
...
def analyze():
    ...
    for idx in top_indices:
        ...
        # เพราะภาษาพูดกับภาษาเขียนหมอ อาจจะไม่ตรงกันเป๊ะ การลดเกณฑ์ช่วยให้เจอข้อมูลง่ายขึ้น
        if score > 0.01: 
            found_any = True
            row = df.iloc[idx]
